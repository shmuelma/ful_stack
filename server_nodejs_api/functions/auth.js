...
//admin.initializeApp({
 ...
 // databaseURL: "https://sever-apinode..firebaseio.com"
//});
/*
const {  db } = require('./admin');

//const { admin, db, firebase } = require('./index');
 const { validateSignUPData, validateLoginData } = require('./check_validation');
//
